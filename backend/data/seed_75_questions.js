...
const questionsData = [
    ...
    bugHunt('q_off_by_one_01', 'OFF_BY_ONE_LOOP_BOUNDARY', 'loop_boundaries', 'Beginner',
    ...
    bugHunt('q_off_by_one_02', 'OFF_BY_ONE_LOOP_BOUNDARY', 'loop_boundaries', 'Beginner',
    ...
    bugHunt('q_off_by_one_03', 'OFF_BY_ONE_LOOP_BOUNDARY', 'loop_boundaries', 'Intermediate',
    ...
    bugHunt('q_off_by_one_04', 'OFF_BY_ONE_LOOP_BOUNDARY', 'loop_boundaries', 'Intermediate',
    ...
    bugHunt('q_off_by_one_05', 'OFF_BY_ONE_LOOP_BOUNDARY', 'loop_boundaries', 'Advanced',
    ...
    bugHunt('q_arr_len_02', 'ARRAY_LENGTH_INDEX_MISUSE', 'array_indexing', 'Beginner',
    ...
    bugHunt('q_arr_len_03', 'ARRAY_LENGTH_INDEX_MISUSE', 'array_indexing', 'Intermediate',
    ...
    bugHunt('q_arr_len_04', 'ARRAY_LENGTH_INDEX_MISUSE', 'array_indexing', 'Intermediate',
    ...
    bugHunt('q_arr_len_05', 'ARRAY_LENGTH_INDEX_MISUSE', 'array_indexing', 'Advanced',
    ...
    codeTrace('q_str_eq_01', 'STRING_EQUALITY_WITH_OPERATOR', 'string_comparison', 'Beginner',
    ...
    codeTrace('q_str_eq_02', 'STRING_EQUALITY_WITH_OPERATOR', 'string_comparison', 'Beginner',
    ...
    codeTrace('q_str_eq_03', 'STRING_EQUALITY_WITH_OPERATOR', 'string_comparison', 'Intermediate',
    ...
    codeTrace('q_str_eq_04', 'STRING_EQUALITY_WITH_OPERATOR', 'string_comparison', 'Intermediate',
    ...
    codeTrace('q_str_eq_05', 'STRING_EQUALITY_WITH_OPERATOR', 'string_comparison', 'Advanced',
    ...
    bugHunt('q_loop_dir_01', 'LOOP_UPDATE_WRONG_DIRECTION', 'loop_control', 'Beginner',
    ...
    bugHunt('q_loop_dir_02', 'LOOP_UPDATE_WRONG_DIRECTION', 'loop_control', 'Beginner',
    ...
    bugHunt('q_loop_dir_03', 'LOOP_UPDATE_WRONG_DIRECTION', 'loop_control', 'Intermediate',
    ...
    bugHunt('q_loop_dir_04', 'LOOP_UPDATE_WRONG_DIRECTION', 'loop_control', 'Intermediate',
    ...
    bugHunt('q_loop_dir_05', 'LOOP_UPDATE_WRONG_DIRECTION', 'loop_control', 'Advanced',
    ...
    bugHunt('q_unreach_01', 'UNREACHABLE_CODE_AFTER_RETURN', 'control_flow', 'Beginner',
    ...
    bugHunt('q_unreach_02', 'UNREACHABLE_CODE_AFTER_RETURN', 'control_flow', 'Beginner',
    ...
    bugHunt('q_unreach_03', 'UNREACHABLE_CODE_AFTER_RETURN', 'control_flow', 'Intermediate',
    ...
    bugHunt('q_unreach_04', 'UNREACHABLE_CODE_AFTER_RETURN', 'control_flow', 'Intermediate',
    ...
    bugHunt('q_unreach_05', 'UNREACHABLE_CODE_AFTER_RETURN', 'control_flow', 'Advanced',
    ...
    bugHunt('q_empty_if_02', 'EMPTY_CONDITIONAL_BODY', 'statement_structure', 'Beginner',
    ...
    bugHunt('q_empty_if_03', 'EMPTY_CONDITIONAL_BODY', 'statement_structure', 'Intermediate',
    ...
    bugHunt('q_empty_if_04', 'EMPTY_CONDITIONAL_BODY', 'statement_structure', 'Intermediate',
    ...
    bugHunt('q_empty_if_05', 'EMPTY_CONDITIONAL_BODY', 'statement_structure', 'Advanced',
    ...
    // ── 9. SELF_ASSIGNMENT (5) ─────────────────────────────────────────────
    bugHunt('q_self_assign_01', 'SELF_ASSIGNMENT', 'assignment_logic', 'Beginner',
    ...
    bugHunt('q_self_assign_02', 'SELF_ASSIGNMENT', 'assignment_logic', 'Beginner',
    ...
    bugHunt('q_self_assign_03', 'SELF_ASSIGNMENT', 'assignment_logic', 'Intermediate',
    ...
    bugHunt('q_self_assign_04', 'SELF_ASSIGNMENT', 'assignment_logic', 'Intermediate',
    ...
    bugHunt('q_self_assign_05', 'SELF_ASSIGNMENT', 'assignment_logic', 'Advanced',
    ...
    codeTrace('q_immutable_02', 'IGNORED_STRING_METHOD_RESULT', 'immutable_strings', 'Beginner',
    ...
    codeTrace('q_immutable_03', 'IGNORED_STRING_METHOD_RESULT', 'immutable_strings', 'Intermediate',
    ...
    codeTrace('q_immutable_04', 'IGNORED_STRING_METHOD_RESULT', 'immutable_strings', 'Intermediate',
    ...
    codeTrace('q_immutable_05', 'IGNORED_STRING_METHOD_RESULT', 'immutable_strings', 'Advanced',
    ...
    bugHunt('q_div_zero_01', 'DIVISION_BY_ZERO_LITERAL', 'arithmetic_operations', 'Beginner',
    ...
    bugHunt('q_div_zero_02', 'DIVISION_BY_ZERO_LITERAL', 'arithmetic_operations', 'Beginner',
    ...
    bugHunt('q_div_zero_03', 'DIVISION_BY_ZERO_LITERAL', 'arithmetic_operations', 'Intermediate',
    ...
    bugHunt('q_div_zero_04', 'DIVISION_BY_ZERO_LITERAL', 'arithmetic_operations', 'Intermediate',
    ...
    bugHunt('q_div_zero_05', 'DIVISION_BY_ZERO_LITERAL', 'arithmetic_operations', 'Advanced',
    ...
    codeTrace('q_false_loop_01', 'CONSTANT_FALSE_LOOP_CONDITION', 'loop_initialization', 'Beginner',
    ...
    codeTrace('q_false_loop_02', 'CONSTANT_FALSE_LOOP_CONDITION', 'loop_initialization', 'Beginner',
    ...
    codeTrace('q_false_loop_03', 'CONSTANT_FALSE_LOOP_CONDITION', 'loop_initialization', 'Intermediate',
    ...
    codeTrace('q_false_loop_04', 'CONSTANT_FALSE_LOOP_CONDITION', 'loop_initialization', 'Intermediate',
    ...
    codeTrace('q_false_loop_05', 'CONSTANT_FALSE_LOOP_CONDITION', 'loop_initialization', 'Advanced',
    ...
    bugHunt('q_while_upd_02', 'WHILE_VARIABLE_NOT_UPDATED', 'loop_termination', 'Beginner',
    ...
    bugHunt('q_while_upd_03', 'WHILE_VARIABLE_NOT_UPDATED', 'loop_termination', 'Intermediate',
    ...
    bugHunt('q_while_upd_04', 'WHILE_VARIABLE_NOT_UPDATED', 'loop_termination', 'Intermediate',
    ...
    bugHunt('q_while_upd_05', 'WHILE_VARIABLE_NOT_UPDATED', 'loop_termination', 'Advanced',
