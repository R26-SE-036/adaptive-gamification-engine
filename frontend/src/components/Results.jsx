...
const Results = () => {
    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
            <Trophy size={64} style={{ color: result.score > 50 ? 'var(--cg-warn)' : 'var(--cg-muted)', margin: '0 auto 24px auto' }} />
            ...
            <div className="glass-panel" style={{ textAlign: 'left', marginBottom: '32px' }}>
                <h3 style={{ borderBottom: '1px solid var(--cg-border)', paddingBottom: '12px', marginBottom: '16px' }}>Session Breakdown</h3>
            ...
            <div className="hint-box" style={{ textAlign: 'left', borderLeftColor: 'var(--accent-color)', backgroundColor: 'rgb(var(--cg-rgb-accent) / 0.1)', color: 'var(--accent-color)' }}>
