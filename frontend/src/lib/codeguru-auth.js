 ...
 *
 * If you need to change how the gamification engine talks to Code Coach's auth
 * API, change it THERE and run code-coach/sync-codeguru-auth.sh. Editing this
 * copy makes the services drift apart, and the field-name mismatches that
 * follow (identifier vs email, full_name vs fullName) are exactly what this
